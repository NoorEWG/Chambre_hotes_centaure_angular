...
@Component({
  selector: 'internalbooking',
  templateUrl: './internalbooking.component.html',
  styleUrls: ['./booking.component.css']
})

export class InternalBookingComponent implements OnInit{
  ...
  validateAccessCode() {
    var $request = "https://paardrijvakantie.com/api/validateInternalBooking.php?code=" + this.code;
    this.http.get($request,httpOptions).subscribe(data => {
      var auth = data;
  ...
  validateForm() {
        if(this.bookingForm.valid) {
          ...
          var params = JSON.stringify(this.user) + "&code=" + this.code; 
          var $request = "https://paardrijvakantie.com/api/saveInternBooking.php?booking=" + params ;
